...
----
include::{path_griffon_gsql_core}/src/main/java/griffon/plugins/gsql/GsqlCallback.java[lines=25..-1]
----
...
GsqlConnectStart(String datasourceName, Map<String, Object> config):: Triggered before connecting to the datasource.
GsqlConnectEnd(String datasourceName, Map<String, Object> config, Sql sql):: Triggered after connecting to the datasource.
GsqlDisconnectStart(String datasourceName, Map<String, Object> config, Sql sql):: Triggered before disconnecting from the datasource.
GsqlDisconnectEnd(String datasourceName, Map<String, Object> config):: Triggered after disconnecting from the datasource.
