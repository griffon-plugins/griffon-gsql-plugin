...
----
dependencies {
    griffon '{project-group}:griffon-gsql-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-gsql-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-gsql-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-gsql-plugin` BOM in your POM file, by placing the following
