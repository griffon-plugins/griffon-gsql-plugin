...
public interface GsqlAwareConstants extends BaseConstants {
    ...
    MethodDescriptor[] METHODS = new MethodDescriptor[]{
        ...
        method(
            type(VOID),
            METHOD_CLOSE_SQL,
            args(annotatedType(types(type(ANNOTATION_NULLABLE)), JAVA_LANG_STRING))
        ),
        ...
        annotatedMethod(
            ...
            typeParams(R),
            METHOD_WITH_SQL,
            args(annotatedType(annotations(ANNOTATION_NONNULL), GSQL_CALLBACK_TYPE, R)),
        ...
        annotatedMethod(
            ...
            args(
                ...
                annotatedType(annotations(ANNOTATION_NONNULL), GSQL_CALLBACK_TYPE, R)),
            throwing(type(RUNTIME_GSQL_EXCEPTION_TYPE))
        )
    };
}
